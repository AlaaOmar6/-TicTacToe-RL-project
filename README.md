...
State Space Verification — generates and validates all 5,478 states
Minimax Computation — recursive value function with gamma discounting
Dynamic Programming — policy iteration until convergence
Consistency Check — verifies DP ≡ Minimax on all 2,423 states
Monte Carlo Training — 100,000 episodes vs. optimal opponent
Q-Learning Training — 100,000 episodes via self-play
SARSA Training — 100,000 episodes via self-play
Greedy Evaluation — deterministic policy assessment
Learning Curves — matplotlib visualization saved to learning_curves_final.png
Expected Output
plain
============================================================
